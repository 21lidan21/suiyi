...
//订单列表
export const GET_ORDERLIST_LIST = 'GET_ORDERLIST_LIST'
export const GET_ORDERLIST_CODE = 'GET_ORDERLIST_CODE'
export const GET_ORDERDETAILS_CODE = 'GET_ORDERDETAILS_CODE'

//事业单位
export const GET_UNDERTAKINGCONTENT_CODE = 'GET_UNDERTAKINGCONTENT_CODE'