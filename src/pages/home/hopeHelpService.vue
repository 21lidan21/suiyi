<template>
    ...
    <div class="main">
    	<div>
    		<span style="color:#BCBCBC;">选择</span><span style="display: inline-block;float: right;color:#58b6e8;" dir="ltr">个人</span>
    	</div>
    	<div><input type="text" placeholder="联系人" /></div>
    	...
    	<div><input type="text" placeholder="事件原由" /></div>
    	<div class="textarea"><textarea placeholder="请描述当前现状描述"></textarea></div>
